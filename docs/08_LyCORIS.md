...
Это продолжение технологии LoRA, но осмысленное именно для генерации диффузионных изображений, а не просто для генеративных моделей.
...
![Lora_vs_Lycoris](/visual/Lora_vs_Lycoris.png)
