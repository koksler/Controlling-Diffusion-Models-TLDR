...
Построили их так, потому что прогресс дискриминативных моделей (или классификационных, определяющих что находится на картинке) был намного быстрее из-за уже существующих и применяемых алгоритмов.
...
<img width="982" height="549" alt="image" src="https://github.com/user-attachments/assets/d1659bac-1516-42b6-8ec6-c0b157a41f3c" />
...
Тут $G(z)$ результат генератора. Функция $D$ это уверенность. Если дискриминатор слишком самоуверенный то $D(G(z))$ будет близок к 0. А $\log{(1)}$ это очень плоская функция.
